WENWU_ERA_TIMELINE = [
    ("新石器时代", ("新石器时代", "兴隆洼文化", "磁山文化", "裴李岗文化", "仰韶文化", "大汶口文化", "龙山文化", "河姆渡文化", "红山文化", "良渚文化", "石家河文化", "肖家屋脊文化"), None),
    ("夏", ("夏", "夏代"), None), ("商", ("商", "商代"), None),
    ("西周", ("西周", "西周早期", "西周中期", "西周晚期"), None),
    ("春秋", ("春秋", "东周", "东周春秋"), None), ("战国", ("战国", "东周战国"), None),
    ("秦", ("秦", "秦代"), None),
    ("西汉", ("西汉", "西汉早期", "西汉中期", "西汉晚期"), None),
    ("东汉", ("东汉", "东汉早期", "东汉中期", "东汉晚期"), None),
    # Do not use the single character 魏 here: it incorrectly catches 北魏 and 魏晋南北朝.
    ("三国", ("三国", "曹魏", "蜀汉", "东吴"), None),
    ("西晋", ("西晋",), None), ("东晋", ("东晋",), None),
    ("南北朝", ("南北朝", "魏晋南北朝", "南朝", "北朝", "十六国", "北魏", "东魏", "西魏", "北齐", "北周", "北燕", "刘宋", "南齐", "梁", "陈"), None),
    ("北魏", ("北魏",), "南北朝"), ("东魏", ("东魏",), "南北朝"),
    ("西魏", ("西魏",), "南北朝"), ("北齐", ("北齐",), "南北朝"),
    ("北周", ("北周",), "南北朝"), ("北燕", ("北燕",), "南北朝"),
    ("刘宋", ("刘宋",), "南北朝"), ("南齐", ("南齐",), "南北朝"),
    ("梁", ("梁", "南朝梁"), "南北朝"), ("陈", ("陈", "南朝陈"), "南北朝"),
    ("隋", ("隋", "隋代"), None), ("唐", ("唐", "唐代"), None),
    ("五代十国", ("五代", "五代十国", "后梁", "后唐", "后晋", "后汉", "后周", "吴越", "闽", "楚", "南汉", "南平", "前蜀", "后蜀", "北汉", "南唐"), None),
    ("后梁", ("后梁",), "五代十国"), ("后唐", ("后唐",), "五代十国"),
    ("后晋", ("后晋",), "五代十国"), ("后汉", ("后汉",), "五代十国"),
    ("后周", ("后周",), "五代十国"), ("吴越", ("吴越",), "五代十国"),
    ("闽", ("闽",), "五代十国"), ("楚", ("楚",), "五代十国"),
    ("南汉", ("南汉",), "五代十国"), ("南平", ("南平",), "五代十国"),
    ("前蜀", ("前蜀",), "五代十国"), ("后蜀", ("后蜀",), "五代十国"),
    ("北汉", ("北汉",), "五代十国"), ("南唐", ("南唐",), "五代十国"),
    ("北宋", ("北宋",), None),
    ("南宋", ("南宋",), None), ("元", ("元", "元代"), None),
    ("明", ("明", "明代"), None), ("清", ("清", "清代"), None),
]
