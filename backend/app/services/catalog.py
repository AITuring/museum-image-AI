...
from app.services.cloud_query import (
    ...
    fetch_cloud_artifact_payload as fetch_cloud_artifact_payload_safe,
    mark_cloud_query_failure,
    mark_cloud_query_success,
    should_proxy_artifact_queries_to_cloud as should_proxy_artifact_queries_to_cloud_safe,
)
...
def should_proxy_artifact_queries_to_cloud() -> bool:
    return should_proxy_artifact_queries_to_cloud_safe()


def fetch_cloud_artifact_payload(
    params: dict[str, object] | None = None,
) -> list[dict]:
    return fetch_cloud_artifact_payload_safe(params)
...
async def fetch_cloud_artifact_match(
    *,
    ...
    except Exception:  # noqa: BLE001 - preview lookup is best-effort
